#!/usr/bin/env python3
"""
Authentication related methods module
"""
import bcrypt
from db import DB
...
class Auth:
    """ Auth class to handle interaction with authentication database """

    def __init__(self):
        """ Initializes new Auth class instance """
        self._db = DB()
    ...
    def get_reset_password_token(self, email: str) -> str:
        ...
        self._db.update_user(user.id, reset_token=pwd_reset_token)
